...
#     # basic rate is 20% for income between 12570 and 50270
#     assert round(calculate_income_tax(12570.01), 3)['total_tax'] == 0.002
#     assert calculate_income_tax(12571)['total_tax'] == 0.20
#     assert calculate_income_tax(12571, 1000)['total_tax'] == 0.20
...
#     assert calculate_income_tax(12571, 1000) == 0.20

#     assert calculate_income_tax(15000) == 486 #0.20 * (15000 - 12570)
#     assert calculate_income_tax(15000, 1000) == 486 #0.20 * (15000 - 12570)
#     assert calculate_income_tax(20000, 1000) == 1486 #0.20 * (20000 - 12570)
